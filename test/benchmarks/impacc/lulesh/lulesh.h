...
// [DEBUG by Seyong Lee] Change below typedef to macro, since some
// OpenCL compiler fails to choose correct math functions due to
// type ambiguity.
/*
typedef float        real4 ;
...
static inline real8  SQRT(real8  arg) { return sqrt(arg) ; }

static inline real8  CBRT(real8  arg) { return cbrt(arg) ; }

static inline real8  FABS(real8  arg) { return fabs(arg) ; }
