...
static void conj_grad (int colidx[NZ+1], int rowstr[NA+1+1], double x[NA+2+1], double z[NA+2+1],
				double a[NZ+1], double p[NA+2+1], double q[NA+2+1], double r[NA+2+1],
				double w[NA+2+1], double *rnorm);
static void makea(int n, int nz, double a[NZ+1], int colidx[NZ+1], int rowstr[NA+1+1],
				int nonzer, int firstrow, int lastrow, int firstcol,
				int lastcol, double rcond, int arow[NZ+1], int acol[NZ+1],
				double aelt[NZ+1], double v[NA+1+1], int iv[2*NA+1+1], double shift );
static void sparse(double a[NZ+1], int colidx[NZ+1], int rowstr[NA+1+1], int n,
				int arow[NZ+1], int acol[NZ+1], double aelt[NZ+1],
				int firstrow, int lastrow,
				double x[NA+1+1], boolean mark[NA+1], int nzloc[NA+1], int nnza);
...
/*
		...
		a = (double *)malloc(sizeof(double)*(NZ+1));
		x = (double *)malloc(sizeof(double)*(NA+2+1));
		z = (double *)malloc(sizeof(double)*(NA+2+1));
		p = (double *)malloc(sizeof(double)*(NA+2+1));
		q = (double *)malloc(sizeof(double)*(NA+2+1));
		r = (double *)malloc(sizeof(double)*(NA+2+1));
		w = (double *)malloc(sizeof(double)*(NA+2+1));
*/
		colidx = (int *)acc_create_unified(NULL, sizeof(int)*(NZ+1));
		rowstr = (int *)acc_create_unified(NULL, sizeof(int)*(NA+1+1));
		a = (double *)acc_create_unified(NULL, sizeof(double)*(NZ+1));
		x = (double *)acc_create_unified(NULL, sizeof(double)*(NA+2+1));
		z = (double *)acc_create_unified(NULL, sizeof(double)*(NA+2+1));
		p = (double *)acc_create_unified(NULL, sizeof(double)*(NA+2+1));
		q = (double *)acc_create_unified(NULL, sizeof(double)*(NA+2+1));
		r = (double *)acc_create_unified(NULL, sizeof(double)*(NA+2+1));
		w = (double *)acc_create_unified(NULL, sizeof(double)*(NA+2+1));
...
static void makea(
				...
				double aelt[NZ+1],	/* aelt[1:nz] */
				double v[NA+1+1],		/* v[1:n+1] */
...
static void sparse(
				...
				double aelt[NZ+1],	/* aelt[1:*] */
				int firstrow,
				int lastrow,
				double x[NA+1+1],		/* x[1:n] */
