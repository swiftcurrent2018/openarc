...
static double u_r[NX];
static double u_i[NX];

/* for checksum data */

/* COMMON block: sumcomm */
//static scomplex sums[NITER_DEFAULT+1]; /* sums(0:niter_default) */
static double sums_r[NITER_DEFAULT+1]; /* sums_r(0:niter_default) */
static double sums_i[NITER_DEFAULT+1]; /* sums_i(0:niter_default) */
