...
static void compute_initial_conditions (double u0_r[NTOTAL],
				double u0_i[NTOTAL]);
static void ipow46 (double a, int exponent, double *result);
static void setup (void);
static void print_timers (void);
static void fft (int dir, double x1_r[NTOTAL], double x1_i[NTOTAL],
				double x2_r[NTOTAL], double x2_i[NTOTAL]);
static void fft_init (int n);
static void cfftz (int is, int m, int n, double x_r[NTOTAL],
				double x_i[NTOTAL], double y_r[NTOTAL], double y_i[NTOTAL],
				int di1, int di2);
static void fftz2 (int is, int l, int m, int n,
				double u_r[NX], double u_i[NX],
				double x_r[NTOTAL], double x_i[NTOTAL],
				double y_r[NTOTAL], double y_i[NTOTAL],
				int di1, int di2);
...
main (int argc, char **argv)
{
		...
		/*--------------------------------------------------------------------
		  ...
		  c-------------------------------------------------------------------*/
		static double u0_r[NTOTAL];		//u0_r[NZ][NY][NX];
		static double u0_i[NTOTAL];		//u0_i[NZ][NY][NX];
		static double u1_r[NTOTAL];		//u1_r[NZ][NY][NX];
		static double u1_i[NTOTAL];		//u1_i[NZ][NY][NX];
		static double u2_r[NTOTAL];		//u2_r[NZ][NY][NX];
		static double u2_i[NTOTAL];		//u2_i[NZ][NY][NX];
		...
		/////////////////////
		int dir;
		static double y0_r[NTOTAL];
		static double y0_i[NTOTAL];
		static double y1_r[NTOTAL];
		static double y1_i[NTOTAL];
		...
		double u1_rf, x11_r, x21_r;
		double u1_if, x11_i, x21_i;

		int idx, p, nn;
		double x11real, x11imag, x21real, x21imag;
...
#pragma acc kernels loop gang worker independent
						...
						{
								sums_r[iter] = sums_r[iter] / (double) (NTOTAL);
								sums_i[iter] = sums_i[iter] / (double) (NTOTAL);
...
/*--------------------------------------------------------------------
  c-------------------------------------------------------------------*/
		...
		static void
compute_initial_conditions (double u0_r[NTOTAL], double u0_i[NTOTAL])
{
...
/*--------------------------------------------------------------------
  c-------------------------------------------------------------------*/
		...
		static void
fft (int dir, double x1_r[NTOTAL], double x1_i[NTOTAL],
				double x2_r[NTOTAL], double x2_i[NTOTAL])
{
