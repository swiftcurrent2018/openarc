...
#pragma openarc #define	EXPMAX	(NITER_DEFAULT*(NX*NX/4+NY*NY/4+NZ*NZ/4))

/* COMMON block: excomm */
static float ex[EXPMAX+1];	/* ex(0:expmax) */
...
//static scomplex sums[NITER_DEFAULT+1]; /* sums(0:niter_default) */
static float sums_r[NITER_DEFAULT+1]; /* sums_r(0:niter_default) */
static float sums_i[NITER_DEFAULT+1]; /* sums_i(0:niter_default) */
