...
do
	...
	inputOpenARCOption="macro=ROW_SIZE=${inputClass},COL_SIZE=${inputClass}"
	k=0 
...
do
	...
	inputOption="${inputClass} ${inputClass} 1 1 /home/f6l/rodinia_1.0/data/hotspot/temp_${inputClass} /home/f6l/rodinia_1.0/data/hotspot/power_${inputClass} output_${inputClass}"
