...
int main(int argc, char **argv)
{
		...
		if(VERIFICATION) {
		  ...
		  double nonAccL2Norm = 0;
			...
			tempCPU = (double *) malloc (grid_rows * grid_cols * sizeof(double));
			powerCPU = (double *) malloc (grid_rows * grid_cols * sizeof(double));
			resultCPU = (double *) malloc (grid_rows * grid_cols * sizeof(double));
