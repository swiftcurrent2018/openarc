...
float* alloc_float(int N)
{
		...
		return (float *)acc_create_unified(NULL, N * sizeof(float));
}
...
int main(int argc, char* argv[])
{
		...
		ff_variable =(float *)acc_create_unified(NULL, sizeof(float) * NVAR);
		...
		// read in domain geometry
		{
				...
				areas =(float *)acc_create_unified(NULL, sizeof(float) * nelr);
				elements_surrounding_elements = (int *)acc_create_unified(NULL, sizeof(int)*nelr*NNB);
				normals = (float *)acc_create_unified(NULL,sizeof(float)*NDIM*NNB*nelr);
...
*/
		acc_delete_unified((void *)areas, 0);
		acc_delete_unified((void *)elements_surrounding_elements, 0);
		acc_delete_unified((void *)normals, 0);

		acc_delete_unified((void *)variables, 0);
		acc_delete_unified((void *)old_variables, 0);
		acc_delete_unified((void *)fluxes, 0);
		acc_delete_unified((void *)step_factors, 0);
		acc_delete_unified((void *)ff_variable, 0);
