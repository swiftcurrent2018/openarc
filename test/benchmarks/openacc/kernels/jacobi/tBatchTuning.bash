...
###########################
baseDir="${openarc}/test/benchmarks/openacc/kernels"
...
if [ "$OPENARC_ARCH" = "0" ] || [ "$OPENARC_ARCH" = "" ]; then
	...
	cleanCmd="make clean"
	makeCmd="make ARC_CUDA"
	baseExeName="${benchmark}_ARC_CUDA"
else
	inputKernelFile="openarc_kernel.cl"
	cleanCmd="make clean"
	makeCmd="make ARC_OPENCL"
	baseExeName="${benchmark}_ARC_OPENCL"
fi
