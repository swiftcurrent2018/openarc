...
*/
	colind = (int *)acc_create_unified(NULL, sizeof(int)*NZR);	
	rowptr = (int *)acc_create_unified(NULL, sizeof(int)*(SIZE+1));	
	values = (float *)acc_create_unified(NULL, sizeof(int)*NZR);	
	x = (float *)acc_create_unified(NULL, sizeof(int)*SIZE);	
	y = (float *)acc_create_unified(NULL, sizeof(int)*SIZE);	
	init_time = timer_() - s_time1;
