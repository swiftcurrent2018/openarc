...
public final class TranslationUnit implements SymbolTable, Traversable {
            ...
            if (p != null) {
                ...
                if (p_name.startsWith("startinclude")) {
                    ...
                    state.remove(0);
                		...
                		p_name.startsWith("OPENCL") || p_name.startsWith("nvl") ||
                		p_name.startsWith("omp") || p_name.startsWith("openarc") ||
                		p_name.startsWith("cetus") ) {
    ...
    * [DEBUG: modified by Seyong Lee] add "o.close()" for debugging purpose. 
    *
    ...
    public void print(PrintWriter o) {
        ...
        try {
        	...
        	if( msg == null ) {
        		...
        		msg = msg + ": IllegalAccessException";
        	}
        	...
        	if( msg == null ) {
        		...
        		msg = msg + ": InvocationTargetException";
        	}
            throw new InternalError(msg);
        }
    }
