...
public final class PrintTools {
    ...
    //[DEBUG] Added by Seyong Lee. To reduce complex message output, add offset to
    //print functions that use System.err.
    private static final int verbosity_offset = 2;
    ...
    */
    public static void printlnStatus(Printable p, int min_verbosity) {
        if (verbosity >= min_verbosity+verbosity_offset) {
    ...
    */
    public static void printlnStatus(int min_verbosity, Object... items) {
        if (min_verbosity+verbosity_offset <= PrintTools.getVerbosity()) {
            if (items.length > 0) {
