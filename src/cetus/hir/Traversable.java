...
public interface Traversable extends Printable {
    ...
    */
     ...
     * 
     * <p>
     * Every concrete descendant class must directly implement (not inherit an
     * implementation for) this method to simply call {@code v.visit(this)}.
     * See {@link TraversableVisitor}.
     * </p>
     * 
     * <p>
     * [Added throughout hierarchy by Joel E. Denny]
     * </p>
     */
    void accept(TraversableVisitor v);
}
