...
public class IPPointsToAnalysis extends IPAnalysis {
    ...
    static {
        ...
        return_to_new.addAll(Arrays.asList(
                ...
                "tmpnam", "acc_malloc", "acc_create", "acc_copyin", 
                "acc_pcopyin", "acc_present_or_copyin", "acc_pcreate",
                "acc_present_or_create", "acc_copyin_unified",
                "acc_pcopyin_unified", "acc_present_or_copyin_unified",
                "acc_create_unified", "acc_pcreate_unified",
                "acc_present_or_create_unified"));
        ...
        safe_library_calls.addAll(Arrays.asList(
                ...
                "acc_init", "acc_shutdown", "acc_on_device", "acc_malloc",
                "acc_free", "get_thread_id", "acc_wait", "acc_wait_all",
                "acc_wait_async", "acc_copyin", "acc_pcopyin", "acc_present_or_copyin",
                "acc_create", "acc_pcreate", "acc_present_or_create", 
                "acc_copyout", "acc_delete", "acc_update_device", "acc_update_self",
                "acc_map_data", "acc_unmap_data", "acc_deviceptr",
                "acc_hostptr", "acc_is_present", "acc_memcpy_to_device",
                "acc_memcpy_from_device", "acc_copyin_unified",
                "acc_pcopyin_unified", "acc_present_or_copyin_unified",
                "acc_create_unified", "acc_pcreate_unified",
                "acc_present_or_create_unified", "acc_copyout_unified",
                "acc_delete_unified"));
    }
        ...
        private AbstractLocation(Expression e, Statement s) {
            ...
            if (e instanceof FunctionCall) {
                if (!StandardLibrary.contains((FunctionCall)e) &&
                		!OpenACCLibrary.contains((FunctionCall)e)) {
    ...
    */
    public Set<CallSite> updateCalls(IPANode node) {
        ...
        for (CallSite call_site : node.getCallSites()) {
            ...
            //FIXME: [Added by Seyong Lee] what if call_site.in() == null or
            //curr_data == null? which occurs while translating LUD by openacc
            //compiler.
            //For now, null-checking code is added, but it needs to be fixed.
            if( (call_site.in() != null) && (curr_data != null) ) {
