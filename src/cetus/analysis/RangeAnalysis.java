...
*/                PrintTools.printlnStatus(toPrettyRanges(symtab, ret, new Integer(0)), 2);
                return ret;
            }
        }
...
/*        if (debug >= 3) {
        ...
        PrintTools.printlnStatus(cfg.toDot("top-order,ranges,ir,tag", 3), 3);
...
/*        if (debug >= 2) {
        ...
        PrintTools.printlnStatus(toPrettyRanges(proc, ret, new Integer(0)), 2);
        return ret;
    }
