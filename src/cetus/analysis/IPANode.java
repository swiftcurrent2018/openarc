...
public class IPANode extends DFANode {
    ...
    */
    ...
    public String toString() {
        ...
        str.append("    IN =\n");
        if (isRoot()) {
            str.append("        ").append(this.in().toString()).append("\n");
        } else {
            for (Set<CallSite> calling_sites : in.keySet()) {
        ...
        str.append("    OUT =\n").append("        ").append(out().toString()).append("\n");
        str.append("    Calls =\n");
        for (CallSite site : getCallSites()) {
            str.append("        ").append(site).append("\n");
            str.append("            IN = ").append(site.in().toString()).append("\n");
            str.append("            OUT = ").append(site.out().toString()).append("\n");
        }
        return str.toString();
    }
}
