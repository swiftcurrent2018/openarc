...
public class PointsToAnalysis extends AnalysisPass {
    ...
    */
    protected static Domain processBasicAssignment(
        ...
        // OUT = GEN U (IN - KILL)
        // FIXME: [Modified by Seyong Lee] Below code incurs null-pointer errors,
        // and thus if any error occurs, simply assign Universe.getUniverse()
        // to output.
        if( (gen != null) && (changed_input != null) && (kill != null) ) {
