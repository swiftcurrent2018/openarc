...
public class LoopCollapse {
	...
	protected Procedure main_proc = null;
	protected TranslationUnit main_TU = null;
	protected HashMap<Symbol, VariableDeclarator> rowIDMap 
		= new HashMap<Symbol, VariableDeclarator>();
	protected VariableDeclarator gpu_rowid_declarator = null;
	protected VariableDeclaration rowid_decl = null;
	//protected boolean rowID_Initialized = false;
	...
	public boolean handleSMVP(Statement parallelRegion, boolean analysisOnly)
	{
		...
		for (OmpAnnotation annot : annot_lists)
		{
			...
			if( !rowIDMap.containsKey(rowptrSym) ) {
				...
				str.append("cudaMalloc((void**) &"+gpu_rowid+", gpuBytes);\n");
	 ...
	 */
	protected boolean ipaIsDefined(Symbol Sym, FunctionCall funcCall ) {
