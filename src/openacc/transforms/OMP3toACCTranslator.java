 ...
 *
 */
public class OMP3toACCTranslator extends TransformPass {
  ...
  protected String pass_name = "[OMP3toACCTranslator]";
  ...
  public OMP3toACCTranslator(Program prog, int numAsyncQueues) {
    super(prog);
    program = prog;
