...
/**
* Repository for CUDA library functions. This class provides a basic
* information about the CUDA library calls. Knowing that if a function call
* may or must not have side effects can greatly improve the precision of a
* program analysis in general. CUDA library calls may have side effects on
* the parameters, on the automatic storage locations, on the file system, and
* on the execution environment.
*/
public class CUDALibrary {

    /** Only a single object is constructed. */
    private static final CUDALibrary std = new CUDALibrary();
    ...
    */
    private void addEntries() {
        ...
        add("__syncthreads_count");
        add("__syncthreads_and");
        add("__syncthreads_or");
        add("__syncwarp");
        add("__threadfence_block");
        add("__threadfence");
